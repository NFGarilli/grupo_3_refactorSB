window.onload = function() {
    ...
    productForm.addEventListener("submit", function(e) {
        ...
        let productCategory = document.queryquerySelector("input.category");
        let productColor = document.queryquerySelector("input.colors");
        let productSize = document.queryquerySelector("input.sizes");
        let productPrice = document.queryquerySelector("input.price");        
